...
VALUES
    ...
    ('ERR_JOURNAL_REJECTION_REASON_REQUIRED', 'Rejection reason is required.', 'error'),
    ('ERR_FORBIDDEN_MANAGER_APPROVAL_REQUIRED', 'Forbidden. Only managers can approve or reject journal entries.', 'error'),
    ...
    ('MSG_JOURNAL_ENTRY_APPROVED_SUCCESS', 'Journal entry approved and posted successfully.', 'success'),
    ('MSG_JOURNAL_ENTRY_REJECTED_SUCCESS', 'Journal entry rejected successfully.', 'success'),
    ('MSG_JOURNAL_QUEUE_REFRESHED', 'Journal queue refreshed.', 'success'),
